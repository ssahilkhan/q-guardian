...
| `[project]` | `name = "q-guardian"`, `version = "1.0.0"`, description *"Q-Guardian: A Hybrid Quantum-Classical Framework for Runtime Security of Autonomous AI Agents"*, `readme = "README.md"`, `license = MIT`, `requires-python = ">=3.12"`, author "Q-Guardian Research Team", keywords, classifiers (Beta, Python 3.12/3.13, MIT, Security/AI) |
...
- `PKG-INFO` — distribution metadata (name `q-guardian`, version `1.0.0`, description, URLs, classifiers, `Requires-Python >=3.12`, full deps + extras).
