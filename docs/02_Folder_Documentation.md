...
The package contains all production code (300 Python files). Top-level subdirectories:
...
|---|---|---|
| `tests/unit/` | 70 test files | Component-level tests (config, events, hooks, plugins, ml, policy, quantum, risk, runtime, sdk, security, utils, fusion) |
...
Totals: **105 `test_*.py` files + 2 `conftest.py` + 5 `__init__.py` = 112 files; 2,339 test functions.**
